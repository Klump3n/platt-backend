...
class _ScenePrototype:
    ...
    def _add_dataset(self, dataset_path):
        """
        Add one dataset.
    ...
    def add_datasets(
        ...
        return_dict = {
            'sceneHash': '{}'.format(self._scene_name),
        ...
        for one_dataset in dataset_list:
            try:
                ...
                dataset_hash = self._add_dataset(one_dataset_path)
                dataset_meta = self._dataset_list[dataset_hash].meta()
