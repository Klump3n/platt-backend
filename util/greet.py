...
greet = [
    ...
    "{}  QOo{}oQQ{}/ajQQQQ{}o{}QQQQQga/{}".format(deep_blue, blue, green, red, green, reset),
    "{}    QOoo{}jQQQQQQQQQQQQQQP{}".format(blue, green, reset),
    "{}     QQQ{}QQ{}Oo{}QQQQQQQQQQ/{}".format(blue, green, red, green, reset),
    "{}       QQQQQ{}wQQWQQQQQQ'{}".format(blue, green, reset),
